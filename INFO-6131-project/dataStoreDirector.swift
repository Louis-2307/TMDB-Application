...
class dataStoreDirector {
    ...
    static let shared =  dataStoreDirector()
    ...
    func getData( hostURl:String ,path: String, params: [String: String]?, completion: @escaping (Result<DirectorStruct?, Error>) -> Void){
        ...
        urlSession.dataTask(with: request) { (data, response, error) in
            ...
            do {
                ...
                let returnStakeholder = try decoder.decode(DirectorStruct?.self, from: data)
